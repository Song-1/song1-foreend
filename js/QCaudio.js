...
/*			if(data.avatarURL){
				...
				getObject('.cover').innerHTML='<img src="./images/avatar/logo.png" alt="音乐1号">';
		...
		init : function(conf){
			...
			if( true ){
				...
				var MP= MPlayer;
				  ...
				  document.getElementById("playlist").appendChild(oplayer)
				 
				  document.getElementById("player").innerHTML=
				   '<div class="cover"><img src="./images/avatar/logo.png" alt="音乐1号"></div>'+
		           '<div class="yctrl">'+
			       '<div class="tag">'+
				   ...
				   '<div class="rewind icon" style="dislpay:none; visibility:hidden; height:0px; width:0px;"></div>'+
				    '<div id="playback" class="playback1 icon1"></div>'+
			...
			'<div class="progress">'+
				...
				'<div class="playerright" style="dislpay:none; visibility:hidden; height:0px; width:0px;">'+
